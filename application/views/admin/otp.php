...
<head>
    ...
    <title>OTP - Exam Management System</title>
    ...
    <div class="signin-panel">
        ...
        <div class="signin-sidebar">
            <div class="signin-sidebar-body">
                ...
                <h4 class="signin-title">OTP Verification</h4>
                <h5 class="signin-subtitle">Please enter the OTP code that was sent to your email.</h5>

                <form action="<?= base_url('admin/register/sending') ?>" method="post">
                    <div class="signin-form">
                        <?= $this->session->flashdata('message'); ?>
                        <div class="form-group">
                            <input type="text" name="otp" autofocus class="form-control text-center form-control-lg" placeholder="otp code">
                        </div>
